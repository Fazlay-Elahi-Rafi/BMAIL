  ...
  return (
    <>
      <div className="footer">
        <Container fluid>
          <Row className="gx-3">
                ...
                <Link to="/">
                  ...
                  >
                    ...
                    <path
                      ...
                      fill="url(#paint0_linear_78_1123)"
                    />
                    <path
                      d="M56.8434 34.4251C60.3793 32.3836 64.7991 34.9354 64.7991 39.0183L64.7991 64.9804C64.7991 69.0632 60.3793 71.6151 56.8434 69.5736L34.3596 56.5926C30.8237 54.5512 30.8237 49.4475 34.3596 47.4061L56.8434 34.4251Z"
                      fill="url(#paint1_linear_78_1123)"
                      stroke="#0A0A0A"
            ...
            <Col xs={12} md={6} lg={3}>
              <div className="list-navs">
                <Link to="/" className="link uppercase">
      ...
      <div className="copyright">
        <p className="copyText">© 2022, BMAIL LIMITED. ALL RIGHTS RESERVED.</p>
      </div>
    </>
  );
};
